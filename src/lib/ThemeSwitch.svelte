...
<div class="themeSelector" 
    ...
    style=" flex-direction: {osIcon === faMobile || horizontal ? "row" : "column"};
            font-size: 0.6rem;
            {style}
...
>
    ...
    <div class="themeSwitch" style="flex-direction: {osIcon === faMobile ? "column" : "row"}" >
